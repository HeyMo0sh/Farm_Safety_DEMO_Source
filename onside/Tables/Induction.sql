CREATE TABLE [Induction] (
    ...
    CONSTRAINT [FK_onside.Induction_onside.ApplicationUser_UserId] FOREIGN KEY ([UserId]) REFERENCES [ApplicationUser] ([Id]),
    CONSTRAINT [FK_onside.Induction_onside.Farm_FarmId] FOREIGN KEY ([FarmId]) REFERENCES [Farm] ([Id])
);


GO
CREATE NONCLUSTERED INDEX [IX_FarmId]
    ON [Induction]([FarmId] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_UserId]
    ON [Induction]([UserId] ASC);
