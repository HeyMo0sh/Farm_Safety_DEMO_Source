CREATE TABLE [RiskTemplateItem] (
    ...
    CONSTRAINT [FK_onside.RiskTemplateItem_onside.RiskTemplateRiskGroup_RiskGroupId] FOREIGN KEY ([RiskGroupId]) REFERENCES [RiskTemplateRiskGroup] ([Id])
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [UX_RiskTemplateItem_RiskGroupId_SortOrder]
    ON [RiskTemplateItem]([RiskGroupId] ASC, [SortOrder] ASC);
