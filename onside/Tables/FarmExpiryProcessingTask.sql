CREATE TABLE [FarmExpiryProcessingTask] (
    [Id]                      BIGINT        NOT NULL,
    ...
    CONSTRAINT [FK_onside.FarmExpiryProcessingTask_onside.Farm_Id] FOREIGN KEY ([Id]) REFERENCES [Farm] ([Id])
);


GO
CREATE NONCLUSTERED INDEX [IX_Id]
    ON [FarmExpiryProcessingTask]([Id] ASC);
