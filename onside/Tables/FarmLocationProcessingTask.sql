CREATE TABLE [FarmLocationProcessingTask] (
    [Id]                      BIGINT        NOT NULL,
    ...
    CONSTRAINT [FK_onside.FarmLocationProcessingTask_onside.FarmLocation_Id] FOREIGN KEY ([Id]) REFERENCES [FarmLocation] ([Id])
);


GO
CREATE NONCLUSTERED INDEX [IX_Id]
    ON [FarmLocationProcessingTask]([Id] ASC);
