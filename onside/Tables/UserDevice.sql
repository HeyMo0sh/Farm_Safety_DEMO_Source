CREATE TABLE [UserDevice] (
    ...
    CONSTRAINT [FK_onside.UserDevice_onside.ApplicationUser_UserId] FOREIGN KEY ([UserId]) REFERENCES [ApplicationUser] ([Id])
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [UX_UserDevice_UserId_DeviceId]
    ON [UserDevice]([UserId] ASC, [DeviceId] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_UserDevice_DeviceId]
    ON [UserDevice]([DeviceId] ASC);
