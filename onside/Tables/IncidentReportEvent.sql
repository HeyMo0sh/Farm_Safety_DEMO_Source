CREATE TABLE [IncidentReportEvent] (
    ...
    CONSTRAINT [FK_onside.IncidentReportEvent_onside.FarmEvent_Id] FOREIGN KEY ([Id]) REFERENCES [FarmEvent] ([Id]),
    CONSTRAINT [FK_onside.IncidentReportEvent_onside.Incident_IncidentId] FOREIGN KEY ([IncidentId]) REFERENCES [Incident] ([Id])
);


GO
CREATE NONCLUSTERED INDEX [IX_Id]
    ON [IncidentReportEvent]([Id] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_IncidentId]
    ON [IncidentReportEvent]([IncidentId] ASC);
