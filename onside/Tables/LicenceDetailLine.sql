CREATE TABLE [LicenceDetailLine] (
    ...
    CONSTRAINT [FK_onside.LicenceDetailLine_onside.ApplicationUser_LicencedUserId] FOREIGN KEY ([LicencedUserId]) REFERENCES [ApplicationUser] ([Id]),
    CONSTRAINT [FK_onside.LicenceDetailLine_onside.LicenceEntity_LicenceEntityId] FOREIGN KEY ([LicenceEntityId]) REFERENCES [LicenceEntity] ([Id])
);


GO
CREATE NONCLUSTERED INDEX [IX_LicencedUserId]
    ON [LicenceDetailLine]([LicencedUserId] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_LicenceEntityId]
    ON [LicenceDetailLine]([LicenceEntityId] ASC);
