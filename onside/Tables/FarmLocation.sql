CREATE TABLE [FarmLocation] (
    ...
    CONSTRAINT [FK_onside.FarmLocation_onside.Farm_FarmId] FOREIGN KEY ([FarmId]) REFERENCES [Farm] ([Id])
);


GO
CREATE NONCLUSTERED INDEX [IX_FarmId]
    ON [FarmLocation]([FarmId] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_FarmLocation_Geohash]
    ON [FarmLocation]([Geohash] ASC);


GO
CREATE SPATIAL INDEX [SX_FarmLocation_GeoFenceCircleCentre]
    ON [FarmLocation] ([GeoFenceCircleCentre])
