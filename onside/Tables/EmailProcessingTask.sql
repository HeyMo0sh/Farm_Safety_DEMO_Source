CREATE TABLE [EmailProcessingTask] (
    ...
    CONSTRAINT [FK_onside.EmailProcessingTask_onside.ApplicationUser_Recipient_Id] FOREIGN KEY ([RecipientId]) REFERENCES [ApplicationUser] ([Id])
);


GO
CREATE NONCLUSTERED INDEX [IX_RecipientId]
    ON [EmailProcessingTask]([RecipientId] ASC);
