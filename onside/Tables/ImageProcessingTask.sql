CREATE TABLE [ImageProcessingTask] (
    [Id]                      BIGINT          NOT NULL,
    ...
    CONSTRAINT [FK_onside.ImageProcessingTask_onside.ImageEntity_Id] FOREIGN KEY ([Id]) REFERENCES [ImageEntity] ([Id])
);


GO
CREATE NONCLUSTERED INDEX [IX_Id]
    ON [ImageProcessingTask]([Id] ASC);
