CREATE TABLE [UserCard] (
    ...
    CONSTRAINT [FK_onside.UserCard_onside.BillPayer_BillPayerId] FOREIGN KEY ([BillPayerId]) REFERENCES [BillPayer] ([Id])
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [UX_UserCard_BillingId]
    ON [UserCard]([BillingId] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_BillPayerId]
    ON [UserCard]([BillPayerId] ASC);
