CREATE TABLE [FarmAdminFarm] (
    ...
    CONSTRAINT [FK_onside.FarmAdminFarm_onside.Farm_FarmId] FOREIGN KEY ([FarmId]) REFERENCES [Farm] ([Id]),
    CONSTRAINT [FK_onside.FarmAdminFarm_onside.FarmAdminRole_FarmAdminRoleId] FOREIGN KEY ([FarmAdminRoleId]) REFERENCES [FarmAdminRole] ([Id])
);


GO
CREATE NONCLUSTERED INDEX [IX_FarmAdminRoleId]
    ON [FarmAdminFarm]([FarmAdminRoleId] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_FarmId]
    ON [FarmAdminFarm]([FarmId] ASC);
